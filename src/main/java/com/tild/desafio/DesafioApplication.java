...
//            });
//        	
//        	List<String> listUsers = Arrays.asList("Josh Long#starbuxman#987654321#josh@outlook.com, Trisha Gee#trisha_gee#63829527#trisha@outlook.com, Mario Fusco#mariofusco#64398658#mario@outlook.com".split(","));
//                    listUsers.stream()
//                    .forEach(t -> {
//                        User user = new User();
//                        user.setName(t.split("#")[0]);
//                        user.setTwitter(t.split("#")[1]);
//                        user.setPhone(t.split("#")[2]);
//                        user.setEmail(t.split("#")[3]);
//
//                        userRepository.save(user);
//                    });
//
